...
public class Space extends World
{
     ...
     */
    /**
     * paintStars is add stars in the world. In color of white and transparent.
     * 
     * @param int count is a counting the stars
     * @return Nothing is returned
     */
    private void paintStars( int count )
    {
        ...
        for ( int i = 0; i < count; i++ )
        {
            ...
            background.setColor( new Color(255, 255, transparency) );
    ...
    /**
     * addAsteroids is add asteroids in the world.
     * 
     * @param int count is a counting the asteroids
     * @return Nothing is returned
     */
     ...
     * 
     * @param There are no parameterso9
     * @return Nothing is returned
     */
    public void gameWon()
    {
