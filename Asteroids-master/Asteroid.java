...
public class Asteroid extends SmoothMover
{
     ...
     */ 
    /**
     * setSize is a method which is setting up the size
     * 
     * @param int size is setting up the size.
     * @return Nothing is returned
     */
     ...
     */
    /**
     * hit is the method that is setting up if the astroid is hit it will bracke into bunch of different sized pices
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
     ...
     */
    /**
     * breakUp is beaking up the astroid if it is damaged and play the explosion sound and remove it from the world.
     * 
     * param int numBreakUp is setting up the peices breaking from the astroid.
     * @return Nothing is returned
     */
